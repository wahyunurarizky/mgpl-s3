...
},{"axios":"../../node_modules/axios/index.js"}],"manageTeam.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateTeam = exports.fillForm = exports.deleteTeam = exports.createTeam = void 0;
...
var deleteTeam = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return (0, _axios.default)({
              method: 'delete',
              url: "/api/v1/teams/".concat(id, "/players")
            });
  ...
  return function deleteTeam(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js"}],"managePlayers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deletePlayer = exports.createPlayer = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            teamId = param[param.length - 1];
            url = "/api/v1/teams/".concat(teamId, "/players");
            _context.next = 6;
            return (0, _axios.default)({
              method: 'post',
              url: url,
...
var deletePlayer = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id) {
    var param, teamId, url, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            param = window.location.href.split('/');
            teamId = param[param.length - 1];
            url = "/api/v1/teams/".concat(teamId, "/players/").concat(id);
            _context2.next = 6;
            return (0, _axios.default)({
              method: 'delete',
              url: url
  ...
  return function deletePlayer(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deletePlayer = deletePlayer;
},{"axios":"../../node_modules/axios/index.js"}],"manageResults.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateResult = exports.addResult = void 0;
...
var addResult = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var url, resSch, schedule, resTeam1, resTeam2, playerT1, playerT2;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "/api/v1/schedules/".concat(id);
            _context.next = 4;
            return (0, _axios.default)({
              method: 'get',
              url: url
          ...
          case 4:
            resSch = _context.sent;
            schedule = resSch.data.data.doc;
            ...
            return (0, _axios.default)({
              method: 'get',
              url: "/api/v1/teams/".concat(schedule.t1.id)
            });

          case 11:
            resTeam1 = _context.sent;
            _context.next = 14;
            return (0, _axios.default)({
              method: 'get',
              url: "/api/v1/teams/".concat(schedule.t2.id)
            });

          case 14:
            resTeam2 = _context.sent;
            playerT1 = resTeam1.data.data.doc.players;
            playerT2 = resTeam2.data.data.doc.players;
            document.getElementById('winner').innerHTML = '';
            document.getElementById('winner').appendChild(new Option('select winner'));
            document.getElementById('winner').appendChild(new Option(schedule.t1.shortName, schedule.t1.id));
            document.getElementById('winner').appendChild(new Option(schedule.t2.shortName, schedule.t2.id));
...
var updateResult = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, resultId) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/api/v1/schedules/".concat(resultId);
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  return function updateResult(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateResult = updateResult;
},{"axios":"../../node_modules/axios/index.js"}],"detailPlayer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.detailPlayer = void 0;
...
var detailPlayer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var resp, player;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'get',
              url: "/api/v1/players/".concat(id)
            });

          case 2:
            resp = _context.sent;
            player = resp.data.data.doc;
            ...
            document.getElementById('mvp').innerHTML = "".concat(player.mvp, " kali");
  ...
  return function detailPlayer(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.detailPlayer = detailPlayer;
},{"axios":"../../node_modules/axios/index.js"}],"resultDetail.js":[function(require,module,exports) {
"use strict";
...
var resultDetail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res, sch, ss, mvp;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            res = _context.sent;
            sch = res.data.data.doc;
            ss = "";
            sch.screenshoots.forEach(function (e) {
              ss += "<img class=\"mb-2\" src=\"/img/ss/".concat(e, "\" width=\"300\" alt=\"\" />");
            });
            document.getElementById('ss').innerHTML = ss;
            mvp = "";
            sch.mvp.forEach(function (e) {
              mvp += "".concat(e.nick, " <br>");
            });
            document.getElementById('mvp').innerHTML = mvp;
            document.getElementById('poin').innerHTML = "".concat(sch.poinTimWin, " - ").concat(sch.poinTimLose);
  ...
  return function resultDetail(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _manageTeam = require("./manageTeam");

var _managePlayers = require("./managePlayers");

var _manageResults = require("./manageResults");

var _detailPlayer = require("./detailPlayer");
...
var formUpdateTeam = document.querySelector('.form--updateTeam');
var editButton = document.querySelectorAll('.edit-team');
var deleteButton = document.querySelectorAll('.delete-team');
var formAddPlayer = document.querySelector('.form--addPlayer');
var deletePlayerButton = document.querySelectorAll('.delete-player');
var addResultButton = document.querySelectorAll('.button-add-result');
...
if (formAddTeam) {
  formAddTeam.addEventListener('submit', function (e) {
    ...
    form.append('logo', document.getElementById('logo').files[0]); // console.log(document.getElementById('logo').files[0]);

    (0, _manageTeam.createTeam)(form);
  });
}

if (formUpdateTeam) {
  formUpdateTeam.addEventListener('submit', function (e) {
    e.preventDefault(); // sama aja buat multipar/form-data

    var formU = new FormData(); // const name = document.getElementById('name').value;
    // const shortName = document.getElementById('shortName').value;
    ...
    formU.append('logo', document.getElementById('logoU').files[0]); // console.log(document.getElementById('logo').files[0]);

    (0, _manageTeam.updateTeam)(formU, document.getElementById('teamId').value);
  });
}
...
if (deleteButton) {
  deleteButton.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _manageTeam.deleteTeam)(button.dataset['id']);
    });
  });
}
...
if (editButton) {
  editButton.forEach(function (button) {
    ...
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _manageTeam.fillForm)(button.dataset['id']);
    });
  });
}

if (addResultButton) {
  addResultButton.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _manageResults.addResult)(button.dataset['id']);
    });
  });
}

if (formAddPlayer) {
  formAddPlayer.addEventListener('submit', function (e) {
    e.preventDefault(); // sama aja buat multipar/form-data
    ...
    form.append('photo', document.getElementById('photo').files[0]); // console.log(document.getElementById('logo').files[0]);

    (0, _managePlayers.createPlayer)(form);
  });
}

if (deletePlayerButton) {
  deletePlayerButton.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _managePlayers.deletePlayer)(button.dataset['id']);
    });
  });
}

if (formUpdateResult) {
  formUpdateResult.addEventListener('submit', function (e) {
    e.preventDefault(); // sama aja buat multipar/form-data

    var winner = '';
    var loser = '';

    if (document.getElementById('winner').value == document.getElementById('team1').value) {
    ...
    formR.append('finish', true); // console.log(document.getElementById('nameU').value);
    // console.log(document.getElementById('logo').files[0]);

    (0, _manageResults.updateResult)(formR, document.getElementById('resultId').value);
  });
}

if (buttonDetailPlayer) {
  buttonDetailPlayer.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _detailPlayer.detailPlayer)(button.dataset['id']);
    });
  });
}

if (buttonResultDetail) {
  buttonResultDetail.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _resultDetail.resultDetail)(button.dataset['id']);
    });
  });
}
